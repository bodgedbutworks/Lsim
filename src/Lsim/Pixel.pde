class Pixel {
  ...
  void loadGui() {
    ...
    pixelExp.put(new IntBox(new PVector(10, 0), new PVector(80, 25), this, "Pixel Width", "Pixel Width", int(faceSize.x), 1, 1, 10000));
    pixelExp.put(new IntBox(new PVector(10, 0), new PVector(80, 25), this, "Pixel Height", "Pixel Height", int(faceSize.y), 1, 1, 10000));
    pixelExp.put(new IntBox(new PVector(10, 0), new PVector(80, 25), this, "Zoom Angle Min", "Zoom Angle Min", zoomAngleMin, 1, 0, 180));
    pixelExp.put(new IntBox(new PVector(10, 0), new PVector(80, 25), this, "Zoom Angle Max", "Zoom Angle Max", zoomAngleMax, 1, 0, 180));
    pixelExp.put(new IntBox(new PVector(10, 0), new PVector(60, 25), this, "Rel. Channel Dimmer", "Rel. Channel Dimmer", chanDimmer, 1, 1, 512));
    pixelExp.put(new IntBox(new PVector(10, 0), new PVector(60, 25), this, "Rel. Channel Zoom", "Rel. Channel Zoom", chanZoom, 1, 1, 512));
    pixelExp.put(new IntBox(new PVector(10, 0), new PVector(60, 25), this, "Rel. Channel Red", "Rel. Channel Red", chanClrR, 1, 1, 512));
    ...
    Expandable faceTypeExp = new Expandable(new PVector(10, 0), new PVector(0, 0), "Pixel Type", true, false, CLR_MENU_LV2);
    faceTypeExp.put(new Button(new PVector(0, 0), new PVector(120, 30), this, "Ellipse", "Ellipse", CLR_MENU_LV3));
    faceTypeExp.put(new Button(new PVector(0, 0), new PVector(120, 30), this, "Rectangle", "Rectangle", CLR_MENU_LV3));
